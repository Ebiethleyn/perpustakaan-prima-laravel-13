    ...
    <div style="width: 100%; font-family: Arial, sans-serif; box-sizing: border-box;">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 30px; width: 100%; box-sizing: border-box;">
            <div
                ...
                <div style="color: #888; font-size: 13px;">Total Koleksi Buku</div>
            </div>
            <div
                style="flex: 1; background-color: #2d2d2d; padding: 20px; border-radius: 6px; text-align: center; border: 1px solid #333;">
                <div style="font-size: 32px; font-weight: bold; color: #ff2d20; margin-bottom: 5px;">
                ...
                <div style="color: #888; font-size: 13px;">Peminjaman Aktif (Siswa)</div>
            </div>
            <div
                style="flex: 1; background-color: #2d2d2d; padding: 20px; border-radius: 6px; text-align: center; border: 1px solid #333;">
                <div style="font-size: 32px; font-weight: bold; color: #ff2d20; margin-bottom: 5px;">
                ...
                <div style="color: #888; font-size: 13px;">Siswa Terregistrasi</div>
            </div>
        </div>
        ...
        <div
            ...
            <h3
                ...
                ⚡ Menu Pintas Kendali Operasional</h3>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 15px;">
                ...
                <a href="{{ route('peminjam.create') }}"
                    ...
                    <div style="color: #fff; font-weight: bold; font-size: 14px;">Registrasi Siswa</div>
                    <div style="color: #666; font-size: 11px; margin-top: 3px;">Tambah akun peminjam baru</div>
                </a>
