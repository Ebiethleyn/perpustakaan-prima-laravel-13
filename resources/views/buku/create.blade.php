...
@section('content')
    ...
    <div style="margin-bottom: 25px;">
        ...
        <h1 style="margin: 10px 0 0 0; color: #ff2d20; font-family: Arial, sans-serif;">Tambah Koleksi Buku Baru</h1>
        <p style="color: #888; margin: 5px 0 0 0; font-size: 14px;">Masukkan detail informasi buku secara lengkap dan valid.
        </p>
    </div>
                ...
                <select id="kategoriId" name="kategoriId" required
                    ...
                    @foreach ($kategori as $kat)
                        <option value="{{ $kat->kategoriId }}"
                            {{ old('kategoriId') == $kat->kategoriId ? 'selected' : '' }}>
                            {{ $kat->namaKategori }}
                        </option>
                    @endforeach
                </select>
